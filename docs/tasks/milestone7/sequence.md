...
1. **01-production-launch-preflight.md** - Freeze the v1 launch scope, fill production fact registers, choose the browser-auth topology, and confirm which manual provider/account steps must happen before agent-led deployment work.
...
4. **04-production-hosting-and-migrations.md** - Provision the free-tier production web, API, and database stack; apply migrations; seed only approved production-safe data; and record real deployment facts.
