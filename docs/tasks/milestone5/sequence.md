...
2. **02-email-adapter-and-config.md** - Implement the Nodemailer adapter, MailHog dev defaults, and SMTP config validation.
...
5. **05-digest-scheduler.md** - Add a deterministic digest runner that can be invoked locally, in CI, or by a hosted scheduler.
...
11. **11-email-docs.md** - Update PRD, README, ADR notes, env docs, and testing docs for email behavior.
