...
## Env Examples
- **API**: `DATABASE_URL`, `JWT_SECRET`, `JWT_REFRESH_SECRET`, `SESSION_BRIDGE_SECRET`, `TF_DEV_BYPASS_AUTH`, `SMTP_HOST`, `SMTP_PORT`, `SMTP_USER`, `SMTP_PASS`, `EMAIL_FROM`, `EMAIL_DAILY_SEND_LIMIT`, `DIGEST_JOB_SECRET`
