      ...
      <section className="grid gap-6 md:grid-cols-[2fr,1fr] md:items-center">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-primary/30 px-3 py-1 text-xs uppercase tracking-[0.2em] text-primary">
            <Sparkles className="h-3 w-3" /> Day 1 Setup
          </span>
          <h2 className="text-4xl font-semibold leading-tight">Monorepo foundations, verified.</h2>
        ...
        >
          <p className="text-sm text-muted-foreground">
            Shared tokens, responsive primitives, and expressive motion are ready across the stack. Import `@taskforge/shared`
            once it exposes fully typed DTOs.
          </p>
        </motion.div>
      </section>
